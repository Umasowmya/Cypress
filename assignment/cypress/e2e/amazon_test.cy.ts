...
context('Search Test', () => {
    ...
    describe('Search the required information', ()=>{
      ...
      it('add third deal to cart',()=>{
        ...
        robotHands.clickOnThirdDeal("div[data-testid='grid-deals-container']>div:nth-child(1)");
        robotHands.clickOnFirstItem(".a-unordered-list.a-nostyle.a-horizontal.a-spacing-none >li  :nth-child(1)>div>div>a ",2);
        
        robotEyes.seesTitle("productTitle");
        robotHands.clickAddToCart("add-to-cart-button");
        robotHands.clickOnId("attach-close_sideSheet-link")
        robotHands.clickOnCart("nav-cart");
        robotEyes.seesQuantity(".a-dropdown-prompt","1");
      ...
      it('get first item delivery details',()=>{
       ...
       it('add payment',()=>{
            ...
            robotHands.addCreditCard(".a-button-input",4)
